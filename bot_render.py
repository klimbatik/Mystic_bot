...
async def handle_date(message: Message):
    ...
    # КНОПКА "СДЕЛАТЬ ПОЛНЫЙ АНАЛИЗ" — сразу после результата
    await message.answer(
        "🎯 <b>Хочешь получить полный анализ?</b>\n"
        "Получи детальный разбор своей Матрицы Судьбы — с деньгами, призванием и кармой.",
