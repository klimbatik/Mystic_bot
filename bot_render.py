...
# ——— подробные описания (длинные, как ты просила) ———
DETAILED_DESCRIPTIONS = {
    (18,6,6): (
        "🔮 <b>Хвост 18-6-6: Любовная магия</b>\n\n"
        "В прошлой жизни ты либо совершал любовные привороты, либо был жертвой — испытывал сильный недостаток любви. "
        "Ты мог использовать чувства как инструмент контроля или сам страдать от зависимости.\n\n"
        "В этой жизни ты часто ищешь любовь вовне, не умея полюбить себя. "
        "Ты нуждаешься в одобрении, боишься быть отвергнутым, и можешь вести разгульную жизнь.\n\n"
        "📌 <b>Задачи этого хвоста:</b>\n"
        "• Полюбить себя — это главный ключ к свободе.\n"
    ...
    (9,9,18): (
        ...
        "Ты обладал глубокими знаниями, но не передал их миру. "
        "Мог использовать их во вред, из страха быть непонятым или чтобы подавить других.\n\n"
        "В этой жизни ты можешь бояться делиться своими знаниями, думая: "
        "«Мои знания никому не нужны» или «Не хочу создавать себе конкурентов».\n\n"
        "📌 <b>Задачи этого хвоста:</b>\n"
