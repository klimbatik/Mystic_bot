...
# 👤 Твой Telegram ID (из @getmyid_bot)
ADMIN_ID = 1030370280

# Хранение пользователей, которые нажали "ГОТОВО" (ожидают ввода даты)
...
async def handle_date(message: Message):
    ...
    # Если пользователь в режиме ожидания после "ГОТОВО"
    if message.from_user.id in waiting_for_date:
        ...
        try:
            ...
            await message.answer("❌ Произошла ошибка. Пожалуйста, напишите мне в личные сообщения.")
    ...
    # Бесплатный анализ (если не ждал оплаты)
